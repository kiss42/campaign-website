...
import logo from "../assets/logo.png"; // Using the campaign logo

const HeroSection = () => {
  const [showForm, setShowForm] = useState(false);

  return (
    <section className="relative text-white text-center md:text-left py-48 px-8 flex items-center justify-center bg-gray-800">
      {/* Content Wrapper */}
      <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start space-y-8 md:space-y-0 md:space-x-12 max-w-6xl mx-auto">
        ...
        <div className="text-center md:text-left">
          <h1 className="text-6xl md:text-6xl font-extrabold uppercase text-highlight drop-shadow-lg">
            The People's Movement
          </h1>
          <p className="text-2xl font-semibold text-highlight mt-6 leading-relaxed max-w-3xl">
